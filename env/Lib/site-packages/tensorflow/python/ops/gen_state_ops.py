...
def Assign(ref, value, validate_shape=True, use_locking=True, name=None):
  return assign(ref=ref, value=value, validate_shape=validate_shape, use_locking=use_locking, name=name)
Assign.__doc__ = assign.__doc__
Assign = _doc_controls.do_not_generate_docs(_kwarg_only(Assign))
...
def AssignAdd(ref, value, use_locking=False, name=None):
  return assign_add(ref=ref, value=value, use_locking=use_locking, name=name)
AssignAdd.__doc__ = assign_add.__doc__
AssignAdd = _doc_controls.do_not_generate_docs(_kwarg_only(AssignAdd))
...
def AssignSub(ref, value, use_locking=False, name=None):
  return assign_sub(ref=ref, value=value, use_locking=use_locking, name=name)
AssignSub.__doc__ = assign_sub.__doc__
AssignSub = _doc_controls.do_not_generate_docs(_kwarg_only(AssignSub))
...
def CountUpTo(ref, limit, name=None):
  return count_up_to(ref=ref, limit=limit, name=name)
CountUpTo.__doc__ = count_up_to.__doc__
CountUpTo = _doc_controls.do_not_generate_docs(_kwarg_only(CountUpTo))
...
def DestroyTemporaryVariable(ref, var_name, name=None):
  return destroy_temporary_variable(ref=ref, var_name=var_name, name=name)
DestroyTemporaryVariable.__doc__ = destroy_temporary_variable.__doc__
DestroyTemporaryVariable = _doc_controls.do_not_generate_docs(_kwarg_only(DestroyTemporaryVariable))
...
def IsVariableInitialized(ref, name=None):
  return is_variable_initialized(ref=ref, name=name)
IsVariableInitialized.__doc__ = is_variable_initialized.__doc__
IsVariableInitialized = _doc_controls.do_not_generate_docs(_kwarg_only(IsVariableInitialized))
...
def ResourceCountUpTo(resource, limit, T, name=None):
  return resource_count_up_to(resource=resource, limit=limit, T=T, name=name)
ResourceCountUpTo.__doc__ = resource_count_up_to.__doc__
ResourceCountUpTo = _doc_controls.do_not_generate_docs(_kwarg_only(ResourceCountUpTo))
...
def ResourceScatterNdAdd(ref, indices, updates, use_locking=True, name=None):
  return resource_scatter_nd_add(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ResourceScatterNdAdd.__doc__ = resource_scatter_nd_add.__doc__
ResourceScatterNdAdd = _doc_controls.do_not_generate_docs(_kwarg_only(ResourceScatterNdAdd))
...
def ResourceScatterNdSub(ref, indices, updates, use_locking=True, name=None):
  return resource_scatter_nd_sub(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ResourceScatterNdSub.__doc__ = resource_scatter_nd_sub.__doc__
ResourceScatterNdSub = _doc_controls.do_not_generate_docs(_kwarg_only(ResourceScatterNdSub))
...
def ResourceScatterNdUpdate(ref, indices, updates, use_locking=True, name=None):
  return resource_scatter_nd_update(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ResourceScatterNdUpdate.__doc__ = resource_scatter_nd_update.__doc__
ResourceScatterNdUpdate = _doc_controls.do_not_generate_docs(_kwarg_only(ResourceScatterNdUpdate))
...
def ScatterAdd(ref, indices, updates, use_locking=False, name=None):
  return scatter_add(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterAdd.__doc__ = scatter_add.__doc__
ScatterAdd = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterAdd))
...
def ScatterDiv(ref, indices, updates, use_locking=False, name=None):
  return scatter_div(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterDiv.__doc__ = scatter_div.__doc__
ScatterDiv = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterDiv))
...
def ScatterMax(ref, indices, updates, use_locking=False, name=None):
  return scatter_max(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterMax.__doc__ = scatter_max.__doc__
ScatterMax = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterMax))
...
def ScatterMin(ref, indices, updates, use_locking=False, name=None):
  return scatter_min(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterMin.__doc__ = scatter_min.__doc__
ScatterMin = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterMin))
...
def ScatterMul(ref, indices, updates, use_locking=False, name=None):
  return scatter_mul(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterMul.__doc__ = scatter_mul.__doc__
ScatterMul = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterMul))
...
def ScatterNdAdd(ref, indices, updates, use_locking=False, name=None):
  return scatter_nd_add(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterNdAdd.__doc__ = scatter_nd_add.__doc__
ScatterNdAdd = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterNdAdd))
...
def ScatterNdSub(ref, indices, updates, use_locking=False, name=None):
  return scatter_nd_sub(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterNdSub.__doc__ = scatter_nd_sub.__doc__
ScatterNdSub = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterNdSub))
...
def ScatterNdUpdate(ref, indices, updates, use_locking=True, name=None):
  return scatter_nd_update(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterNdUpdate.__doc__ = scatter_nd_update.__doc__
ScatterNdUpdate = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterNdUpdate))
...
def ScatterSub(ref, indices, updates, use_locking=False, name=None):
  return scatter_sub(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterSub.__doc__ = scatter_sub.__doc__
ScatterSub = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterSub))
...
def ScatterUpdate(ref, indices, updates, use_locking=True, name=None):
  return scatter_update(ref=ref, indices=indices, updates=updates, use_locking=use_locking, name=name)
ScatterUpdate.__doc__ = scatter_update.__doc__
ScatterUpdate = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterUpdate))
...
def TemporaryVariable(shape, dtype, var_name="", name=None):
  return temporary_variable(shape=shape, dtype=dtype, var_name=var_name, name=name)
TemporaryVariable.__doc__ = temporary_variable.__doc__
TemporaryVariable = _doc_controls.do_not_generate_docs(_kwarg_only(TemporaryVariable))
...
def Variable(shape, dtype, container="", shared_name="", name=None):
  return variable(shape=shape, dtype=dtype, container=container, shared_name=shared_name, name=name)
Variable.__doc__ = variable.__doc__
Variable = _doc_controls.do_not_generate_docs(_kwarg_only(Variable))
...
def VariableV2(shape, dtype, container="", shared_name="", name=None):
  return variable_v2(shape=shape, dtype=dtype, container=container, shared_name=shared_name, name=name)
VariableV2.__doc__ = variable_v2.__doc__
VariableV2 = _doc_controls.do_not_generate_docs(_kwarg_only(VariableV2))
